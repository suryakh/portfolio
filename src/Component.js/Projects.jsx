                            ...
                            <div className="col-12" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="250">
                                <div className="card justify-content-center" style={{ "height": "300px" }}>
                                    ...
                                    <div className="card_text col-12">
                                        <div className="col-12" >
                                            <a className="stretched-link" href="https://googletimer.netlify.com" target="blank"><h3>GoogleTimer & GoogleStopWatch</h3></a>
                                            <br />
                        ...
                        <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-2">
                            <div className="col-12" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500">
                                <div className="card justify-content-center" style={{ "height": "300px" }}>
                                    ...
                                    <div className="card_text col-12">
                                        <div className="col-12">
                                            <a className="stretched-link" href="https://checklist-todo.netlify.com" target="blank"><h4>TODO Application</h4></a>
                        ...
                        <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-2">
                            <div className="col-12" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500">
                                <div className="card justify-content-center" style={{ "height": "300px" }}>
                                    ...
                                    <div className="card_text col-12">
                                        <div className="col-12">
                                            <a className="stretched-link" href="https://omdbproject.netlify.com" target="blank"><h3>Open Movie Data Base</h3></a>
                        ...
                        <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-2">
                            <div className="col-12" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="750">
                                <div className="card justify-content-center" style={{ "height": "300px" }}>
                                    ...
                                    <div className="card_text col-12">
                                        <div className="col-12">
                                            <a className="stretched-link" href="https://billgenerator.netlify.com" target="blank"><h3>Bill Generator</h3></a>
                        ...
                        <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-2">
                            <div className="col-12" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="750">
                                <div className="card justify-content-center" style={{ "height": "300px" }}>
                                    ...
                                    <div className="card_text col-12">
                                        <div className="col-12">
                                            <a className="stretched-link" href="https://marksrecorder.netlify.com" target="blank"><h3>Marks Recorder</h3></a>
                        ...
                        <div className="col-12">
                            <div className="col-12" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="250">
                                <div className="card justify-content-center" style={{ "height": "300px" }}>
                                    ...
                                    <div className="card_text col-12">
                                        <div className="col-12" >
                                            <a className="stretched-link" href="https://github.com/suryakh/Taskmanager/tree/master/task_list" target="blank"><h3>Task Manager</h3></a>
                                            <br />
